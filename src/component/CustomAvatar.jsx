...
export default function CustomAvatar({ size = 38, isChange = false }) {
  ...
  const handleChange = (e) => {
    ...
    file.preivew = URL.createObjectURL(file);

    setAvatar(file.preivew);
  };
      ...
      <Row justify={"center"}>
        <Col>
          <Avatar size={"large"} className="avatar" style={sizeAvatar}>
            <Image src={avatar} alt="avatar" width={30} height={25} />
          </Avatar>
          {vip && (
            <Image
              src={crown}
