      ...
      <>
        ...
        <MovieList category="Các phim đã kích hoạt Vip Mode">
          <p className={styles.desc}>
            ...
            muốn dùng lúc nào cũng được. Chẳng hạn tài khoản bạn còn 5.000 coin,
            thì 10 năm sau quay lại trang web bạn vẫn có thể dùng 5.000 coin đó
            để kích hoạt VIP Mode cho phim.
          </p>
